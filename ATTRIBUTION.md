...
This repo collects the skills I actually run. Many were written by other people. This file records what is verifiable from the files themselves. Where a skill declares an author or ships a license, that is reproduced below unchanged.
...
| Author | Skills |
|---|---|
| sarthib7 | `bench-it`, `fresh-eyes`, `prove-it`, `followup-review`, `adhd` |
...
That cuts both ways: there are probably more skills here that I wrote than the four listed above. I have only claimed the ones I am certain about. The rest stay unattributed until I am.
